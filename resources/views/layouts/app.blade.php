...
<html lang="en">
<head>
    <title>AykinCakaloz Kariyer</title>
    <script
...
@if (Auth::check())
    <ul class="nav nav-pills">
        ...
        <li role="presentation" @if(Route::current()->getName() == 'admin-stats') class="active" @endif ><a href="{{ route('admin-stats') }}">İstatistikler</a></li>
    </ul>
@endif
